...
write_for: bge s0 %len end_write
	lw a1 (s1) #Достаем текущий счетчик и кладем в a1 для запуска to_string
	...
	append_loop: #в a0 адрес буфера текущего счетчика, теперь посимвольно припишем его в fin_buf
		lb s3 (a0) 
